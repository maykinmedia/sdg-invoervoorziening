# Generated by Django 2.2.24 on 2021-08-18 15:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='De code van het desbetreffende informatiegebied.', max_length=3, verbose_name='code')),
                ('informatiegebied', models.CharField(help_text='Het bij de gegevens behorende informatiegebied.', max_length=40, verbose_name='informatiegebied')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_telefoonnummer', models.CharField(blank=True, help_text='Het telefoonnummer van de verantwoordelijke contactpersoon.', max_length=20, null=True, verbose_name='contact telefoonnummer')),
                ('contact_emailadres', models.EmailField(blank=True, help_text='Het e-mailadres van de verantwoordelijke contactpersoon.', max_length=254, null=True, verbose_name='contact emailadres')),
                ('owms_identifier', models.URLField(help_text='De metadatastandaard voor informatie van de nederlandse overheid op internet.', verbose_name='owms identifier')),
                ('owms_pref_label', models.CharField(help_text='De wettelijk erkende naam van de organisatie.', max_length=80, verbose_name='owms pref label')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lokale_overheid', models.ForeignKey(blank=True, help_text='De lokale overheid die bij deze catalogus hoort.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='catalogi', to='core.LokaleOverheid', verbose_name='lokale overheid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generieke_tekst', markdownx.models.MarkdownxField(help_text='De Nationale Portalen schrijven een inleidende, algemene tekst over het product. Het idee is dat deze ', verbose_name='generieke tekst')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('procedure_beschrijving', markdownx.models.MarkdownxField(help_text='Procedurebeschrijving.', verbose_name='procedure beschrijving')),
                ('vereisten', markdownx.models.MarkdownxField(help_text='Vereisten auth/id/sign.', verbose_name='vereisten')),
                ('bewijs', markdownx.models.MarkdownxField(help_text='Bewijs (type/format).', verbose_name='bewijs')),
                ('bezwaar_en_beroep', markdownx.models.MarkdownxField(help_text='Bezwaar en beroep.', verbose_name='bezwaar en beroep')),
                ('kosten_en_betaalmethoden', markdownx.models.MarkdownxField(help_text='Kosten en betaalmethoden.', verbose_name='kosten en betaalmethoden')),
                ('uiterste_termijn', markdownx.models.MarkdownxField(help_text='Deadlines.', verbose_name='uiterste termijn')),
                ('wtd_bij_geen_reactie', markdownx.models.MarkdownxField(help_text='Wat te doen bij geen reactie.', verbose_name='wtd bij geen reactie')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specifieke_tekst', markdownx.models.MarkdownxField(help_text='Decentrale omschrijving.', verbose_name='specifieke tekst')),
                ...
                ('catalogus', models.ForeignKey(help_text='Referentie naar de catalogus waartoe dit product behoort.', on_delete=django.db.models.deletion.CASCADE, related_name='producten', to='core.ProductenCatalogus', verbose_name='product specifiek informatie')),
                ('generiek_product', models.OneToOneField(help_text='Een verwijzing naar de generieke versie van dit product', on_delete=django.db.models.deletion.PROTECT, related_name='specifiek_product', to='core.ProductGeneriekInformatie', verbose_name='generiek product')),
                ('gerelateerd_product', models.ForeignKey(blank=True, help_text='Een verwijzing naar een gerelateerd product.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='gerelateerd', to='core.ProductSpecifiekInformatie', verbose_name='gerelateerd aan')),
                ('product', models.OneToOneField(blank=True, help_text='Een verwijzing naar een ander product.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='gerefereerd', to='core.ProductSpecifiekInformatie', verbose_name='refereert aan')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(help_text='De code van het desbetreffende thema.', max_length=3, verbose_name='code')),
                ('thema', models.CharField(help_text='Het thema dat verband houdt met de gegevens.', max_length=40, verbose_name='thema')),
                ('informatiegebied', models.OneToOneField(help_text='Het informatiegebied met betrekking tot dit thema.', on_delete=django.db.models.deletion.PROTECT, related_name='thema', to='core.Informatiegebied', verbose_name='informatiegebied')),
            ],
            options={
                'verbose_name': 'thema',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('upn_uri', models.URLField(help_text='Uniforme Productnaam URI van landelijk product', verbose_name='UPN URI')),
                ('upn_label', models.CharField(help_text='Het bijbehorende label. Zie https://standaarden.overheid.nl/owms/oquery/UPL-actueel.plain voor de volledige UPL. ', max_length=255, verbose_name='UPN label')),
                ('thema', models.ForeignKey(help_text='Het informatiegebied met betrekking tot dit thema.', on_delete=django.db.models.deletion.PROTECT, related_name='upn', to='core.Thema', verbose_name='thema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decentrale_link', models.URLField(help_text='Link naar decentrale productpagina voor burgers en / of bedrijven.', verbose_name='decentrale link')),
                ('datum_wijziging', models.DateTimeField(help_text='Decentrale overheden geven een wijzigingsdatum mee voor hun informatie. Deze datum wordt op het portaal getoond. ', verbose_name='datum wijziging')),
                ('product_titel_uitvoering', models.CharField(help_text='De titel van het  product, die immers kan afwijken van de landelijke titel.', max_length=50, verbose_name='product titel_uitovering')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='specifiek_aanvraag', to='core.ProductSpecifiekInformatie', verbose_name='specifiek product'),
        ),
        migrations.AddField(
            model_name='productgeneriekinformatie',
            name='upn',
            field=models.ForeignKey(help_text='De uniforme productnaam met betrekking tot dit product.', on_delete=django.db.models.deletion.PROTECT, related_name='generiek_product', to='core.UniformeProductnaam', verbose_name='uniforme productnaam'),
        ),
        migrations.AddField(
            model_name='productgeneriekinformatie',
            name='verantwoordelijke_organisatie',
            field=models.ForeignKey(help_text='Organisatie verantwoordelijk voor de landelijke informatie', on_delete=django.db.models.deletion.PROTECT, related_name='generiek_informatie', to='core.Overheidsorganisatie', verbose_name='verantwoordelijke organisatie'),
        ),
        migrations.CreateModel(
            name='Lokatie',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.ProductSpecifiekAanvraag', verbose_name='product')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='Bevoegd gezag verantwoordelijk voor de procedure.', on_delete=django.db.models.deletion.CASCADE, related_name='bevoegde', to='core.Overheidsorganisatie', verbose_name='bevoegde organisatie'),
        ),
        migrations.AddField(
            model_name='lokaleoverheid',
            name='ondersteunings_organisatie',
            field=models.ForeignKey(help_text='Organisatie voor ondersteuning.', on_delete=django.db.models.deletion.CASCADE, related_name='ondersteunings', to='core.Overheidsorganisatie', verbose_name='ondersteunings organisatie'),
        ),
        migrations.AddField(
            model_name='lokaleoverheid',
            name='verantwoordelijke_organisatie',
            field=models.ForeignKey(help_text='Organisatie verantwoordelijk voor de decentrale informatie.', on_delete=django.db.models.deletion.CASCADE, related_name='verantwoordelijke', to='core.Overheidsorganisatie', verbose_name='verantwoordelijke organisatie'),
        ),
    ]
