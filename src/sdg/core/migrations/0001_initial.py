# Generated by Django 2.2.24 on 2021-08-16 15:57
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "naam",
                    models.CharField(
                        help_text="De naam van de organisatie.",
                        max_length=40,
                        verbose_name="naam",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "beschikbare_talen",
                    models.CharField(
                        help_text="Naast de taal van de informatie, dient ook aangegeven te worden in welke aanvullende taal/talen de procedure kan worden uitgevoerd. elke productbeschrijving is in één taal (nl of en). De 'additional languages' betreft dus altijd de andere taal (en of nl). Aanname: de portalen richten zich uitsluitend op Nederlands en Engels, geen andere talen.",
                        max_length=255,
                        verbose_name="beschikbare talen",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product_titel_decentraal",
                    models.CharField(
                        help_text="Decentrale producttitel.",
                        max_length=50,
                        verbose_name="product titel decentraal",
                    ),
                ),
